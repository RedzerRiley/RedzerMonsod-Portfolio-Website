    ...
    >
      {showIcon && (
        <span className="about-skill__icon">
          <SimpleIcon
            slug={skill.icon}
            color={hovered ? skill.color : "#7d7d7d"}
            size={14}
          />
        </span>
      )}

      <span className="about-skill__name">
        {skill.name}
      </span>
    </div>
  );
...
export default function AboutPage() {
  const [activeSkillCat, setActiveSkillCat] =
    useState("All");
    ...
    <div className="about">
      ...
      <header className="about-masthead">
        ...
        <div className="about-byline">
          ...
          <span className="about-byline__sep">
            ·
          </span>
      ...
      <section className="about-intro">
        <div className="about-intro__grid">
          ...
          <div className="about-prose">
            <div className="about-prose__body">
              <p>
                ...
                <strong>
                  BS in Computer Science at Mapúa University
                </strong>
                , after transferring from BS Physics.
                That background strengthened my analytical
                thinking and taught me to approach complex
                problems through systems thinking and
              ...
              <p>
                ...
                <strong>
                  Full-stack Developer Head Intern at Pru
                  Life UK
                </strong>
                , where I took on leadership
                responsibilities, coordinated with teams,
                and contributed to projects within a
                structured corporate environment.
                Previously, my internship at{" "}
                <strong>
                  CloudSwyft
                </strong>{" "}
                as a{" "}
                ...
                gave me hands-on experience with Open edX
                deployments, ERD design, debugging, and
                frontend development.
              </p>

              <p>
                I value clean architecture, maintainable
                code, and thoughtful problem-solving. I'm
                currently expanding my skills in{" "}
                <strong>
                  DevOps, cloud-native technologies, and
                  scalable software systems
                </strong>
                , with a focus on building reliable and
          ...
          {/* ── Details ── */}
          <dl className="about-specs about-specs--clean">
            <p className="about-specs__label">
              Details
            </p>
          ...
          <div className="about-skill-groups">
            {groupedSkills.map((group) => (
              <div
                ...
                key={group.category}
              >
                <p className="about-skill-group__label">
                  {group.category}
                </p>
