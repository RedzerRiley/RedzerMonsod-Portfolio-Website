...
const contactLinks = [
  ...
  { 
    ...
    label: "phone",    
    value: "(+63) 920 434 1124",    
    href: "tel:+639204341124" 
  },
  { 
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
export default function ContactPage() {
  ...
  const onSubmit = e => {
    ...
    window.location.href = `mailto:redzerriley@gmail.com?subject=${sub}&body=${body}`;
    setSent(true);
  };
  ...
  const inputStyle = {
    ...
    borderRadius:"var(--radius-sm)", width:"100%", padding:"10px 14px", outline:"none",
    ...
    <section className="min-h-screen px-6 pt-32 pb-24">
      <div className="max-w-4xl mx-auto space-y-12">
        <div className="anim-fade-up text-center">
          <SectionHeader label="./contact" title="send_message()" centered
        ...
        <div className="grid md:grid-cols-2 gap-8">
          ...
          <div className="anim-fade-up delay-100 space-y-3">
            <p className="font-mono text-xs" style={{ color: "var(--text-faint)" }}>// contact_details</p>
              ...
              <div key={label} className="card p-4 flex items-center gap-3.5">
                ...
                <div>
                  ...
                  {href ? (
                    ...
                    <p className="font-mono text-xs font-semibold" style={{ color: "var(--text)" }}>{value}</p>
                  )}
                </div>
              </div>
            ))}
            ...
            {sent ? (
              <div className="card p-8 flex flex-col items-center gap-4 text-center h-full justify-center">
                ...
                <p className="font-mono text-xs" style={{ color: "var(--text-faint)" }}>
                  Or email directly: redzerriley@gmail.com
                </p>
                <button onClick={() => setSent(false)} className="btn-ghost text-xs py-2 px-4 mt-1">
                  send_another()
                </button>
              </div>
            ) : (
              <form onSubmit={onSubmit} className="card p-5 space-y-4">
                <p className="font-mono text-xs" style={{ color: "var(--text-faint)" }}>// compose_message</p>
                {[
                ...
                <div className="space-y-1.5">
                  <label className="font-mono text-xs" style={{ color: "var(--text-faint)" }}>const message =</label>
