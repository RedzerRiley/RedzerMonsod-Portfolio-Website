...
export default function ContactModal({ isOpen, onClose }) {
  ...
  return (
    <>
      <div onClick={onClose} className="fixed inset-0 bg-black/75 backdrop-blur-sm z-[100] animate-in fade-in duration-200" />
      <div className="fixed inset-0 z-[101] flex items-center justify-center p-6 pointer-events-none">
        <div className="w-full max-w-lg bg-[var(--bg-card)] border border-[var(--border-mid)] rounded-[var(--radius-lg)] shadow-2xl pointer-events-auto overflow-hidden animate-in slide-in-from-bottom-4 duration-300">
